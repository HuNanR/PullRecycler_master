package com.example.pullrecycler;
...
import com.example.refreshview.OnLoadListener;
import com.example.refreshview.PullRefreshView;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRefreshView = (PullRefreshView) findViewById(R.id.refresh_view);
        ...
        mRefreshView.setOnLoadListener(new OnLoadListener() {
            @Override
